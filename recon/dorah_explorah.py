...
def scan_by_regular_nmap(script_chosen, scan_str):
    ...
    complete_str = """NMAP scans complete, check your scans at: /root/ArmsCommander{0}
    """.format(
        savefile_name
    )
...
def select_by_category():
    ...
    category_list_str = os.system("cat /root/ArmsCommandernmap_script_category_list")
