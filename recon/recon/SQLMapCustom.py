...
logfile_directory = '/root/ArmsCommander/logs/SQLMap/'
...
def URL_Connect():
    ...
    logfile_name_traffic = logfile_directory + URL_Connect.save_Traffic_File + 'txt'
    logfile_name_config = logfile_directory + URL_Connect.save_Config + '.ini'
...
#save_Traffic_File, save_Config, dump_Format
    ...
    logfile_name_traffic = logfile_directory + DBMS_Connect.save_Traffic_File + 'txt'
    logfile_name_config = logfile_directory + DBMS_Connect.save_Config + '.ini'
