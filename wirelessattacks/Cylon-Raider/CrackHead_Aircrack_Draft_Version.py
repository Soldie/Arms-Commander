...
def main():
    ...
    os.system('cd /root/ArmsCommander/logs/Cylon-Raider/FOUND_PASSWORDS') # that means this is the solution, automatically navigating the terminal to the desired directory
    ...
    # found_password_folder = '/root/ArmsCommander/logs/Cylon-Raider/FOUND_PASSWORDS/'
