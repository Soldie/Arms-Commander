...
def bannerPage():
    ...
    print colored('Arms Commander v0.0.5 by Chang Tan Lister, Limited Release, Alpha Implementation','red','on_white')
    print """
    Welcome to "Arms Commander", the premier command console for preset initial hacking attacks on dedicated "Hacker Battleships".
    """
    print colored('Whats New','red','on_white')
    print """
    Version v.0.0.5
    !!!! New Logfile Folder /root/ArmsCommander/logs, new log/txt files will be created when you capture credentials (like Violent Python Menu #3, Credit Card Sniffer)
    !!!! Several still-working examples from Violent Python have been included under Option #10 "Violent Python POCs" including but not limited too...
    (1) Credit Card Information Sniffer (2) SSH Brute Forcer (Dictionary Attack) (3) Zipfile password cracker (4) LAN FTP Credential Sniffer
    (5) Exif Data Fetcher (6) Mitnick Attack
    """
    return
